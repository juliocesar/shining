(function($) {
  ...
  function loadSlideStyle(name) {
    $('link.slide').remove();
    $('head').append('<link rel="stylesheet" type="text/css" href="' + slidePath(name).style() + '" media="all" class="slide"/>')
  }
